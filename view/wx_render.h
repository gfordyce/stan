...
namespace stan {
    ...
    class WxRender
    {
         ...
         */
        static void render_node(boost::shared_ptr<node>& n, wxPaintDC& dc, wxRect& rc);
         ...
         */
        static void render_figure(boost::shared_ptr<figure>& fig, wxPaintDC& dc, wxRect& rc);
         ...
         */
        static void render_frame(boost::shared_ptr<frame>& fr, wxPaintDC& dc, wxRect& rc);
         ...
         * how they are played.
         */
        static void render_animation(boost::shared_ptr<animation>& an, wxPaintDC& dc, wxRect& rc);
    };
